import svgPaths from "./svg-ljydydvlk5";
import imgGiftCard2 from "figma:asset/650c1dce8eccbc92dd7b80d76b0979ebc7155227.png";
  ...
  return (
    <div className="absolute contents left-[8px] top-[109px]" data-name="GiftCard">
      <div className="absolute h-[359px] left-[calc(50%+2px)] top-[109px] translate-x-[-50%] w-[418px]" data-name="giftCard 2">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgGiftCard2} />
      </div>
      <Group />
    </div>
  );
...
function Refrshicon() {
  return (
    <div className="absolute left-[365px] size-[40px] top-[72px]" data-name="refrshicon">
...
export default function Component1() {
  return (
    <div className="relative size-full" data-name="主层级-消息" style={{ backgroundImage: "linear-gradient(90deg, rgba(255, 255, 255, 0.5) 0%, rgba(255, 255, 255, 0.5) 100%), linear-gradient(90deg, rgb(255, 247, 212) 0%, rgb(255, 247, 212) 100%)" }}>
      <Group4 />
      <Component />
